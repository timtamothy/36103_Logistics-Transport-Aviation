...
text_tbl <- data.frame(
  Stakeholders = c("Airline company executives", "Airline company employees", "Shareholders and investors of Airline companies", ""),
  Features = c(
...
One of the regression models we are considering using in this report is the multiple linear regression (MLR) model.
As the causes of flight delays would not always be just one. The causes of delay could be weather, operating issues, air traffic control, a certain date such as holiday, etc.  There will be more than one independent variable. We will intend to examine how much influence each variable has on the dependent variable.
