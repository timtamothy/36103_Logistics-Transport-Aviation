...
## 2.1 What are the main causes for Airline delays? (Variables that influence departure delays)
...
The residual plots seen in Fig. X elucidates a few findings regarding the dataset. In the Residual vs. Fitted plot, patterns are difficult to view as the number of individual flights is quite high, however, residuals do not appear to be spread equally. A larger portion of the dataset has values above the horizontal line.
