...
# Outline (Do not touch, will delete after. Using this as checklist)
...
Competitor Delays in Q1 

AA, Delta, United Delay comparisons 

Dataset Information (p2) 
...
Exploratory Analysis (p2, 3) 

Simple EDA 

Metrics on data type, Zeros, NAs, missing values 
...
Include distribution of the variables 

Correlation Matrix 

chi-square independence test (nominal) / Spearman rank correlation coefficient (ordinal) & point-biserial correlation test 

Cleaning (short) 

Any transformations done to variables 

Modeling (p4, 5) 

Choice of multivariate linear model 
